#include"nvdla.h"
void fc4(){reg_write(CDMA_S_POINTER_0,0x10001);//group0
...
reg_write(CDMA_D_DATAIN_SIZE_0_0,0x000000);//1*1



reg_write(CDMA_D_DATAIN_SIZE_1_0,119);//*120
...
reg_write(CDMA_D_DAIN_ADDR_LOW_0_0,0x81400000);
...
reg_write(CDMA_D_LINE_STRIDE_0,1*8);//1*8



reg_write(CDMA_D_SURF_STRIDE_0,1*8*1);//1*8*8
...
reg_write(CDMA_D_ENTRY_PER_SLICE_0,14);
...
reg_write(CDMA_D_WEIGHT_SIZE_0_0,1*1*120);//0x1000  1*1*120



reg_write(CDMA_D_WEIGHT_SIZE_1_0,83);//84个kernel
...
reg_write(CDMA_D_WEIGHT_ADDR_LOW_0,0x80400000);



reg_write(CDMA_D_WEIGHT_BYTES_0,1*1*120*84);
...
reg_write(CSC_D_DATAIN_SIZE_EXT_0_0,0x000000);//1*1



reg_write(CSC_D_DATAIN_SIZE_EXT_1_0,119);//*120
...
reg_write(CSC_D_ENTRY_PER_SLICE_0,14);
...
reg_write(CSC_D_WEIGHT_SIZE_EXT_0_0,0x00000);//1*1



reg_write(CSC_D_WEIGHT_SIZE_EXT_1_0,0x530077);//channel=120,kernel=84



reg_write(CSC_D_WEIGHT_BYTES_0,1*1*120*84);
...
reg_write(CSC_D_DATAOUT_SIZE_1_0,83);//*84
...
reg_write(CACC_D_DATAOUT_SIZE_1_0,83);//*84
...
reg_write(CACC_D_LINE_STRIDE_0,1*8);



reg_write(CACC_D_SURF_STRIDE_0,1*8*1);
...
reg_write(SDP_D_DATA_CUBE_WIDTH_0,0x00);//1*1*84
...
reg_write(SDP_D_DATA_CUBE_CHANNEL_0,83);



reg_write(SDP_D_DST_BASE_ADDR_LOW_0,0x81500000);
